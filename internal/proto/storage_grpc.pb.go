...
func (UnimplementedVideoContentStorageServiceServer) SendFiles(context.Context, *BatchSendRequest) (*SendResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendFiles not implemented")
}
...
func RegisterVideoContentStorageServiceServer(s grpc.ServiceRegistrar, srv VideoContentStorageServiceServer) {
	// If the following call panics, it indicates UnimplementedVideoContentStorageServiceServer was
